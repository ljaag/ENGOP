...
%==========================================================================
    ...
    if has_constraints
        ...
        plot_c = max(history.max_c, 1e-12);
        semilogy(outer_iters, plot_c, 'r-o', 'LineWidth', 2, ...
    ...
    if save_plot
        ...
        filename = fullfile(save_folder, sprintf('%s_Convergence.fig', safe_name));
        savefig(f_fig, filename);
