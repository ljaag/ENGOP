...
params_simp_plot.R4 = x_opt_simp(2);            
...
params_simp_plot.L5 = tiny; params_simp_plot.L7 = 0.05;
% Re-compute L1 
params_simp_plot.L1 = 0;
[~,by_temp] = blade_structure(params_simp_plot);
params_simp_plot.L1 = params.H_req - max(by_temp);
...
%figure
scatter(results_simp.x_def, results_simp.y_def, 20, stress_data_simp.sigma_max, "filled", MarkerEdgeColor="none")
axis equal; grid on; grid minor;
colorbar(location="eastoutside");
