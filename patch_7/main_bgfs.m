...
L_start = [0.1+rand*0.025, 0.07+rand*0.025, 0.1+rand*0.025];
R_start = [0.05+rand*0.025, 0.05+rand*0.025, 0.05+rand*0.025];
theta_start = [-70, 150];
x0_full = [t_start, L_start, R_start, theta_start];
lb_full = [0.005 * ones(1,7), 0.02, 0.02, 0.02, 0.02, 0.02, 0.02, -120, 5];
